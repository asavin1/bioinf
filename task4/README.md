...
*   **Способ получения**: Использована командная строка PyMOL: `show cartoon, (name c+o+n+ca)`.
*   **Итоговое изображение**:
...
*   **Способ получения**: Отображена вторичная структура (`S > ribbon`), лишние элементы скрыты.
*   **Итоговое изображение**:
